...
let table = {
    ...
    <div class="max">
    <div class="d1" >
        <img decoding="async" loading="lazy" class="myImg" src="./img/b1.jpg">
    </div>
    <div class="d2">
        <img decoding="async" loading="lazy" class="myImg" id="myImg" src="./img/b2.jpg">
    </div>
    <div class="d3">
    <img decoding="async" loading="lazy" class="myImg" id="myImg" src="./img/b3.jpg" alt="Triangle Image">
    </div>
    <div class="d4">
    <img decoding="async" loading="lazy" class="myImg" id="myImg" src="./img/b5.jpg">
    </div>
    <div class="d5">
    <img decoding="async" loading="lazy" class="myImg" id="myImg" src="./img/b5.jpg">
    </div>
    ...
    <div class="d8">
    <img decoding="async" loading="lazy" class="myImg" id="myImg" src="./img/b4.jpg">
    </div>
    <!-- 弹窗 -->
